---
name: "integrator"
description: "Integrate-shaped tasks — changes across consequential behavioral seams, ambiguous debugging, refactors with behavior at stake. Choosing a new design shape rather than working within one → designer. Task grade: senior."
---

<!-- GENERATED by agent-machinery:scripts/build-agents.mjs. Edit source blocks or agent-machinery:staffing/catalog.json. -->
<!-- AGENT_RUN_ROUTING {"role":"integrator","taskGrade":"senior","domainRequirements":[],"topology":"worker","tier":"senior","reasoning":"high","posture":"deliver","composition":{"kind":"template","id":"integrator","overrides":[]}} -->
