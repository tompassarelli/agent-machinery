...
description: >-
  ...
  handing work back to the user — and whenever a draft has grown long
...
> ✓ Build still fails. Cause is the copy step preserving mode 555 from an
> immutable package tree, so cleanup cannot unlink the generated file.
